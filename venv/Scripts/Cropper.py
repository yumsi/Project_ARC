...
def create_dirs():
    """
    Function creates filestructure if it doesnt already excists
    """
    print("test")
    try:
        os.makedirs("Dataset/Cito_voor/Difference")
        os.makedirs("Dataset/Cito_voor/Duo")
        os.makedirs("Dataset/Cito_voor/Normal")
        os.makedirs("Dataset/Cito_voor/Ratio")
        os.makedirs("Dataset/Cito_voor/RatioDifference")
        os.makedirs("Dataset/Cito_voor/Tumor")

        os.makedirs("Dataset/Cito_achter/Difference")
        os.makedirs("Dataset/Cito_achter/Duo")
        os.makedirs("Dataset/Cito_achter/Normal")
        os.makedirs("Dataset/Cito_achter/Ratio")
        os.makedirs("Dataset/Cito_achter/RatioDifference")
        os.makedirs("Dataset/Cito_achter/Tumor")

        os.makedirs("Dataset/Mito_voor/Difference")
        os.makedirs("Dataset/Mito_voor/Duo")
        os.makedirs("Dataset/Mito_voor/Normal")
        os.makedirs("Dataset/Mito_voor/Ratio")
        os.makedirs("Dataset/Mito_voor/RatioDifference")
        os.makedirs("Dataset/Mito_voor/Tumor")

        os.makedirs("Dataset/Mito_achter/Difference")
        os.makedirs("Dataset/Mito_achter/Duo")
        os.makedirs("Dataset/Mito_achter/Normal")
        os.makedirs("Dataset/Mito_achter/Ratio")
        os.makedirs("Dataset/Mito_achter/RatioDifference")
        os.makedirs("Dataset/Mito_achter/Tumor")

        os.makedirs("Dataset/Grids")
